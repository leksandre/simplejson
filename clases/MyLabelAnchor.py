...
class MyLabelForAnchor(Label):
    def __init__(self, text, componentMbst=False, **kwargs):
        super(MyLabelForAnchor, self).__init__(**kwargs)
...
class MyLabelAnchor(AnchorLayout):
    def __init__(self, text, componentMbst=False, **kwargs):
        super(MyLabelAnchor, self).__init__(**kwargs)
        self.componentMbst = componentMbst
        ...
        label = MyLabelForAnchor(text=text)
